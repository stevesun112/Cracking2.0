...
/* My algorithm:
 * Traverse the whole string from the beginning, put the char that has been checked into a hashmap,
 * if this is a new char (we haven't met before), we'll put it into the hashmap, and increment the length
 * by one, if it's not new, we'll put this element into a new hashmap value, assign the length to len variable,
 * start a new counter and continue this process until we hit the end of the string. */

/* Cool, I spent exactly two hours and figured this problem out! Implemented the following code and made it run!
 * 
 * There were a couple very frustrating moments when I truly wanted to give up! But I hung in here and
 * persevered till the end! */

public class LongestSubstrNoRepeatingChar {

	public static void findSubstr(String s){
